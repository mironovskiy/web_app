                        ...
                        <div class="main-menu">
                            <ul>
                                ...
                                <c:if test="${sessionScope.userRole == 'client'}">
                                    <li><a onclick="window.location.href = 'controller?command=go_to_authorization_page'" href="#">Профиль</a></li>
                                </c:if>
                                <c:if test="${sessionScope.userRole == null}">
                                    <li><a onclick="window.location.href = 'controller?command=go_to_authorization_page'" href="controller?command=go_to_authorization_page">Войти</a></li>
                                </c:if>
                            </ul>
                        </div> <!-- /.main-menu -->
                    </div> <!-- /.col-md-8 -->
